...
# -------------------------------
# Utility: Smart trimming
# -------------------------------
def smart_trim(data, threshold=0.5):
    """Remove static beginning/end parts based on velocity."""
...
def load_and_preprocess_data(root_dir, target_length, augment=False):
    ...
    for motion in folders:
        csvs = glob.glob(os.path.join(root_dir, motion, "*.csv"))
